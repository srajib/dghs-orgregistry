...
<a href="<?php echo $this->base;?>/orgexport.php">Export Excel </a>
    <h3><a href="<?php echo $this->base; ?>/pages/bangladesh/">Bangladesh</a></h3>

    <table class="tableHeader" id="drafts" cellpadding="0" cellspacing="0" border="1" bordercolor="#EEEEEE" align="center" width="52%" style="font-size:11px;">
        <tr>
...
//exit;
        ...
        foreach($AllCode as $AllCodes):
            ...
            <tr>
                ...
                <td align="left"><?php echo $AllCodes['Division']['name']?></td>
