...
?>
<a href="<?php echo $this->base; ?>/exportexcel.php?type=2&div=<?php echo $divs['divisions']['division_id']; ?>">Export Excel</a>
...
?>
				...
				<td>
<td><a href="<?php echo $this->base;?>/edit.php?id=<?php echo $DivOrgs['Organization']['organization_id']; ?>">Edit</a></td>
                        </tr>
