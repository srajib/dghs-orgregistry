...
<a href="<?php echo $this->base; ?>/exportexcel.php?type=3&dis=<?php echo ($disid); ?>">Export Excel</a>
<h3><a href="<?php echo $this->base; ?>/pages/admin/">Bangladesh</a><font color="#FF0000"> >> </font>

<?php
/*foreach($div as $divs):*/
?>
<a href="<?php echo $this->base; ?>/pages/admindivision/<?php echo $divsid; ?>"><?php echo $divname; ?></a><font color="#FF0000"> >> </font>
<?php
/*endforeach;*/
?>

 <a href="<?php echo $this->base; ?>/pages/admindistrict/<?php  echo ($disid); ?>/<?php  echo $divsid; ?>"><?php  echo ($distname); ?></a>
 <?php
...
?>
                        <tr>
						   ...
						   <td nowrap="nowrap"><?php echo $DistOrgs['OrganizationType']['type_name']?></td>
						  <!-- <td><?php echo $DistOrgs['Organization']['email']?></td>-->
						   <td ><?php echo $DistOrgs['Division']['name']?></td>
						   <td ><?php echo $DistOrgs['District']['name']?></td>
						 
				<td>
<td><a href="<?php echo $this->base;?>/edit.php?id=<?php echo  $DistOrgs['Organization']['organization_id']; ?>">Edit</a></td>
                        </tr>
