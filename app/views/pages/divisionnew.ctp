...
?>
<h3><a href="<?php echo $this->base; ?>/pages/bangladeshnew/">Bangladesh</a> <font color="#FF0000">>></font> <a href="<?php echo $this->base; ?>/pages/divisionnew/<?php echo $divs['divisions']['division_id']; ?>"><?php echo $divs['divisions']['name']; ?></a></h3>
				...
				if ($i++ % 2 == 0) {
					$class = 'style="background-color:#E0E0E0"';
                        ...
                        <tr>
						   ...
						   <td nowrap="nowrap"><?php echo $DivOrgs['OrganizationType']['name']?></td>
