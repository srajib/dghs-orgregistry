...
<div id="siteWrapper">
		...
		<div id="siteMenuWrapper">
					...
					<ul>
					<li><a href="http://test.dghs.gov.bd/orgreg">Home</a></li> 
					</li>
...
echo "<meta http-equiv='refresh' content='2; url=".$_SERVER['SERVER_NAME']."/orgreg/pages/admin/'>";
...
<div id="tabs">
    <ul>
		...
		<li><a href="#fragment-4" style="background-color:#D6ECFA"><span><font color="#000000"font size="1.5">Ownership & Additional Information</font></span></a></li>
    </ul>


<div id="fragment-1" style="height:500px;">  <div style="margin-left:10px;float:left;width:400px;">
...
<td>
<?php
						   $path =$url.$books_rows['email'] .'.jpg';
						   $imgurl_check = $path;
							  if (!is_array(@getimagesize($imgurl_check)))
							  { ?>
					<img src="<?php echo $this->base; ?>/img/no_image.gif" width="150" height="100">

						<?php	   }else{
							?>
					
					<img src ="<?php echo $url.$books_rows['email'].'.jpg';?>" width="150" height="100" />
					<?php  } ?>
					</td>-->
</tr>
  ...
  <div id="fragment-2" style="height:500px;"> 
