...
<head>
<meta charset="utf-8">
<title>Organization Details | Organization Login</title>
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab1">
                                    ...
                                    <ul>
                                        ...
                                        <li style="font-size:14px; line-height:35px">Organization Code:<input type="text" name="orgcode" value="<?php echo $rorg1['organization_code']; ?>"></li> 
                                        <li style="font-size:14px; line-height:35px">Organization Type: 
                                        <select id="select01">
                                        <option value="">--Select Type--</option>
                                         <?php
										 $type = mysql_query("SELECT * FROM org_types ORDER BY name");
										 ...
										 ?>
                                            <option value="<?php echo $rowtype['type_id']; ?>" <?php echo $s1; ?>><?php echo $rowtype['name']; ?></option>
                                         <?php
										 }
										 ?>
                                         </select>
								...
								<div class="tab-pane" id="tab2">
                                    ...
                                    <li style="font-size:14px; line-height:35px">Division:
                                        ...
                                        <li style="font-size:14px; line-height:35px">Upazila:
										 ...
										 ?>
                                            <option value="<?php echo $rowupa['district_id']; ?>" <?php echo $s8; ?>><?php echo $rowupa['name']; ?></option>
                                         <?php
										 }
										 ?>
                                          </select>
                                        ...
                                        <li style="font-size:14px; line-height:35px">Longitude:<input type="text" name="long"></li>
                                        <li style="font-size:14px; line-height:35px">Latitude:<input type="text" name="lat"></li>
								...
								<div class="tab-pane" id="tab3">
									...
									<ul>
                                        ...
                                        <li style="font-size:14px; line-height:35px">Fax Number1: <input type="text" name="fax1"></li>
